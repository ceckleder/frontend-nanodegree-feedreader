...
$(function() {
    ...
    describe('RSS Feeds', function() {
        ...
        it('url is not empty', function() {
            allFeeds.forEach(function(feed) {
                ...
                expect(feed.url.length).not.toBe(0); //rule out empty string
            });
        });
    ...
    describe('The Menu', function() {
        ...
        describe('Menu changes visibility', function() {
            ...
            it('Menu is open after click', function() {
                expect($('body')).not.toHaveClass('menu-hidden');
            });

            it('Menu is closed after second click', function() {
                expect($('body')).toHaveClass('menu-hidden');
            });
        });
    });
     ...
     */
       beforeEach(function(done){
        ...
        it('Single .entry exists in .feed container', function(done) {
            expect($('.feed')).toExist(); //matcher from jasmine-jquery
